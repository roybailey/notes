...
| `kubectl apply -f <k8 defintion file.yml>` | Apply the k8 definition file (does this create/update?) |
| `kubectl rollout undo <k8 defintion file.yml>` | Apply the k8 definition file (does this create/update?) |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTQ0NDkzODgyLC03MzMwMjMyMiwxNjM1OD
A5ODQ1LC0xNDIzMjQ1NzIwLDMyODU4MzU3LC02NTg4ODI1Njcs
LTE0MTc1MjgxODEsMTQ5NDQyMjY5NCwyMDEyMjY1NjE4LDMyND
I1OTMzMywyMDU3MTQwMzcyLDEyOTg2ODM3MzIsLTg4MTkyNDQ2
MywtMTQxMTQyNDI0MCwxNzA5NzEzOTc3LDE5ODczNTkyMjIsMT
UzNjQ1ODEwMCwxNzU4Mjc4OTY5XX0=
-->