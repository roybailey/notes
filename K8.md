...
app: myapp spec:    
  containers:    
    - name: nginx-container    
      image: nginx  
 env: - name: MYPASSWORD value: mysecretpassword```  
...
spec:    
  replicas: 3  
 template: metadata:      name: myapp-pod  
 labels:        app: myapp  
 containers:      - name: nginx-container    
        image: nginx  
 env: - name: MYPASSWORD value: mysecretpassword selector: matchLabels: app: myapp```  
...
iface enp0s8 inet static  
 address 192.168.99.110 netmask 255.255.255.0```  
