...
| Command | Description |
|--|--|
| `kubectl create <name> --image=<namespace>/<image-name> --port=<port-number>` | Runs a container image in a pod configured with port mapping |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MTc1MjgxODEsMTQ5NDQyMjY5NCwyMD
